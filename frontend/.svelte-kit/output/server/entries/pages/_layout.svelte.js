...
import { a as authLoading, i as isAuthenticated } from "../../chunks/auth.js";
const getStores = () => {
...
function Header($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let pathname = page$1.url.pathname;
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (store_get($$store_subs ??= {}, "$authLoading", authLoading)) {
      ...
      $$renderer2.push("<!--[!-->");
      if (!store_get($$store_subs ??= {}, "$isAuthenticated", isAuthenticated) && !isLoginPage) {
        $$renderer2.push("<!--[-->");
        Loading($$renderer2);
      } else {
        $$renderer2.push("<!--[!-->");
